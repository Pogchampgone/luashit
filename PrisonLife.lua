---912.596497, 95.1273117, 2152.77954
--game.Players.LocalPlayer.Character:MoveTo(Vector3.new(5625.734375, 52.183319091797, -17259.158203125))
...
b:Button("Tp To Criminal Car",function()
  game.Players.LocalPlayer.Character:MoveTo(Vector3.new(-912.596497, 95.1273117, 2152.77954))
end)

b:Button("Give All Guns",function()
...
b:Label("Made by Pastebin#9785",Color3.fromRGB(255,55,0),Color3.fromRGB(0,0,0))
